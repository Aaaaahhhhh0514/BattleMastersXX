...
/**
 * Enhanced Item.Armor class with set bonuses and durability
 */
class Armor extends Item {
    ...
    public Armor(String name, int defense, String armorType, int weight) {
        super(name, String.format("%s armor providing %d defense", armorType, defense), "Item.Armor", defense * 10, weight);
    ...
    public void addResistance(String element, int amount) {
        resistances.put(element, resistances.getOrDefault(element, 0) + amount);
    }
