...
/**
 * Enhanced Item.Weapon class with elemental damage and special effects
 */
class Weapon extends Item {
    ...
    public Weapon(String name, int power, String element, int weight) {
        super(name, String.format("A %s weapon with %d power", element, power), "Item.Weapon", power * 12, weight);
        this.power = power;
